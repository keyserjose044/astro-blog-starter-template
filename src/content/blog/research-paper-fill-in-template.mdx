...
Each box has a purpose and the template helps to isolate information into expected spots. This helps recognize patterns between different studies at a glance.
