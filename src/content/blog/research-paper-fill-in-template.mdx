...
<div class="example-grid">
  <img src="/templates/examples/rpfo-ex-1.png" alt="Example — front" loading="lazy" />
  <img src="/templates/examples/rpfo-ex-2.png" alt="Example — back" loading="lazy" />
</div>
...
<style>
  ...
  .example-grid img {
    width: 100%;
    max-width: 520px;          /* keeps them tidy on huge screens */
    height: auto;
    border-radius: 12px;
