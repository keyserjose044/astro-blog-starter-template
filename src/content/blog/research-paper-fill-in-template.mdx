...
Below are two real examples — front and back — from an actual research summary sheet.

<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem;">
  <img src="/templates/examples/rpfo-ex-1.png" alt="Research Paper Fill-In Template Example Front" style="max-width: 480px; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);" loading="lazy" />
  <img src="/templates/examples/rpfo-ex-2.png" alt="Research Paper Fill-In Template Example Back" style="max-width: 480px; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);" loading="lazy" />
</div>
...
1. **Print a stack** or open in tablet note-app (GoodNotes / OneNote / iPadOS).  
...
👉 <a href="/templates/Research-Paper-Fill-In-Template.docx" target="_blank" rel="noopener noreferrer" class="btn btn-primary"><strong>Download Customizable Word Template</strong></a>
...
## 🧱 Related Templates
- [To-Do List Template](/templates/Original-To-Do-List-Template.docx)  
- [LifeLoggerz RD Sheet (coming soon)](/templates/)
